...
describe("API Sandbox Tests - No Receipt Data - Should Return 400", function() {
    it("should return a status code of 400 with text of receipt data missing", function(done) {
        request(app)
            .get("/0.1/sandbox")
            .end(function(err, res) {
                expect(res.statusCode).to.equal(400);
                expect(res.text).to.equal("Receipt data is missing.");
                done();
            });
    });
});
...
describe("API Sandbox Tests - With Receipt Data - Should Return 200", function() {
    it("should return a status code of 200", function(done) {
        request(app)
            .get("/0.1/sandbox")
            .query({receipt: receiptData})
            .end(function(err, res) {
                console.log(res);
